...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form target="hiddenIframe" class="form-update-info" action="/MiniTwitter/Website/updateInfo" method="post" id="form-update-info" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="profile-pic-div">
                        <%--<img src="../../w8_admin/bootstrap/img/StickFiguesCoffee.png" class="profile-pic" alt="profile picture here">--%>
                        <img onclick="var el = document.getElementById('uploadImage'); el.click();" src="/MiniTwitter/API/users/profile_image?username=${currentUser.username}" class="profile-pic" alt="profile picture here">
                    </div>
                    <input id="uploadImage" name="file" type="file" multiple style="visibility:hidden;"/>
